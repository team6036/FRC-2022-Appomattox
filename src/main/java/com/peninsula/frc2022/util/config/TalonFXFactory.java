...
public class TalonFXFactory {
  ...
  public static TalonFX createDefaultTalon(int id, String name) {
    return createTalon(id, kDefaultConfiguration, name);
  }

  public static TalonFX createPermanentSlaveTalon(int id, int master_id, String name) {
    final TalonFX talon = createTalon(id, kSlaveConfiguration, name);
    talon.set(ControlMode.Follower, master_id);
    return talon;
  }

  public static TalonFX createTalon(int id, Configuration config, String name) {
    ...
    talon.configForwardLimitSwitchSource(
        LimitSwitchSource.FeedbackConnector, LimitSwitchNormal.Disabled, kTimeoutMs);
