...
public class FalconFactory {
  ...
  public static Falcon createDefaultTalon(int id, String name) {
    return createTalon(id, kDefaultConfiguration, name);
  }

  public static Falcon createTalon(int id, Configuration config, String name) {
    Falcon talon = new Falcon(id, name);
