...
public class RightDownRoutine extends TimeoutRoutineBase {

  public RightDownRoutine(double timeout) {
    super(timeout);
  }
  ...
  public void update(@ReadOnly Commands commands, @ReadOnly RobotState state) {
    ...
    commands.rightStateClimbWanted = AutoClimbController.RightArmState.DOWN;
  }
