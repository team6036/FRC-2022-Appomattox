...
public class LeftStretchRoutine extends TimeoutRoutineBase {

  public LeftStretchRoutine(double timeout) {
    super(timeout);
  }
  ...
  public void update(@ReadOnly Commands commands, @ReadOnly RobotState state) {
    ...
    commands.leftStateClimbWanted = AutoClimbController.LeftArmState.STRETCH_MIN;
  }
