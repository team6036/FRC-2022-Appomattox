...
public class LeftExtendPartialRoutine extends TimeoutRoutineBase {

  public LeftExtendPartialRoutine(double timeout) {
    super(timeout);
  }
  ...
  public void update(@ReadOnly Commands commands, @ReadOnly RobotState state) {
    ...
    commands.leftStateClimbWanted = AutoClimbController.LeftArmState.CLOSE_TO_EXTEND;
  }
