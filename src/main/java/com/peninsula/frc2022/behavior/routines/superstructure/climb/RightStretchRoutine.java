...
public class RightStretchRoutine extends TimeoutRoutineBase {

  public RightStretchRoutine(double timeout) {
    super(timeout);
  }
  ...
  public void update(@ReadOnly Commands commands, @ReadOnly RobotState state) {
    ...
    commands.rightStateClimbWanted = AutoClimbController.RightArmState.STRETCH_MIN;
  }
