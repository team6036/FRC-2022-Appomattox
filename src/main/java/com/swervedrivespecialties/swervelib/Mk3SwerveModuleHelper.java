...
public final class Mk3SwerveModuleHelper {
  ...
  private static SteerControllerFactory<?, NeoSteerConfiguration<CanCoderAbsoluteConfiguration>>
      getNeoSteerFactory(Mk3ModuleConfiguration configuration) {
  ...
  /**
   * Creates a Mk3 swerve module that uses Falcon 500s for driving and steering. Module information
  ...
  /**
   * Creates a Mk3 swerve module that uses NEOs for driving and steering. Module information is
  ...
  /**
   * Creates a Mk3 swerve module that uses a Falcon 500 for driving and a NEO for steering. Module
  ...
  /**
   * Creates a Mk3 swerve module that uses a NEO for driving and a Falcon 500 for steering. Module
   * information is displayed in the specified ShuffleBoard container.
   *
   * @param container The container to display module information in.
   * @param configuration Module configuration parameters to use.
  ...
  public enum GearRatio {
    ...
    /** Mk3 swerve in the fast gear configuration with tread in wheel diameter. */
    FAST_WITH_TREAD(SdsModuleConfigurations.MK3_FAST_WITH_TREAD);
