...
public class ModuleConfiguration {
   ...
   * @param driveReduction The overall drive reduction of the module. Multiplying motor rotations by
   ...
   * @param steerReduction The overall steer reduction of the module. Multiplying motor rotations by
   *     this value should result in rotations of the steering pulley.
   ...
   *
   * <p>If this value is multiplied by steering motor rotations the result would be steering pulley
   * rotations.
   */
