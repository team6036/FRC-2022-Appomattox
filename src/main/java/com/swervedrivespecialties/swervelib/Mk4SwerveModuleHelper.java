...
public final class Mk4SwerveModuleHelper {
  ...
  /**
   * Creates a Mk4 swerve module that uses NEOs for driving and steering. Module information is
  ...
  /**
   * Creates a Mk4 swerve module that uses a Falcon 500 for driving and a NEO for steering. Module
  ...
  /**
   * Creates a Mk4 swerve module that uses a NEO for driving and a Falcon 500 for steering. Module
   * information is displayed in the specified ShuffleBoard container.
   *
   * @param container The container to display module information in.
   * @param configuration Module configuration parameters to use.
